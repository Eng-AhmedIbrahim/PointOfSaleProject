...
public partial class AccountsPage
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {
            _canViewOrderDetails = (await _authorizationService.AuthorizeAsync(user, "CanViewOrderDetails")).Succeeded;
            _canPrintOrderReport = (await _authorizationService.AuthorizeAsync(user, "CanPrintStaffAccounts")).Succeeded;
        }
    ...
    private async Task LoadData()
    {
        ...
        try
        {
            // By default showing Cashiers as they are the primary "Accounts" stakeholders
