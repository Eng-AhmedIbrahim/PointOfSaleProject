...
public abstract class ArabicConstStrings
{
    public const string Quantity = "كمية";
    public const string Name = "الصنف";
    public const string Price = "السعر";
    public const string Total = "اجمالي";
    public const string Discount = "الخصم";
    public const string Service = "الخدمة";
